...
export class Entities1716223265353 implements MigrationInterface {
    name = 'Entities1716223265353'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`cartItems\` (\`id\` int NOT NULL AUTO_INCREMENT, \`bookPrice\` varchar(255) NULL, \`quantity\` int NOT NULL, \`bookId\` int NOT NULL, \`cartId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
