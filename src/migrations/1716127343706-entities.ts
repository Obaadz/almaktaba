...
export class Entities1716127343706 implements MigrationInterface {
    name = 'Entities1716127343706'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`books\` (\`id\` int NOT NULL AUTO_INCREMENT, \`key\` varchar(255) NOT NULL, \`bucket\` varchar(255) NOT NULL, \`mime\` varchar(255) NOT NULL, \`title\` varchar(255) NOT NULL, \`status\` int NOT NULL, \`price\` varchar(255) NOT NULL, \`authorId\` int NULL, UNIQUE INDEX \`REL_54f49efe2dd4d2850e736e9ab8\` (\`authorId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`REL_54f49efe2dd4d2850e736e9ab8\` ON \`books\``);
